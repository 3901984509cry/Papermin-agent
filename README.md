...
> **文档来源声明**
>
> 本 README 的内容基础与叙事框架来自项目作者cry.穷完成的两页手写 AI 项目总结《PaperMind：面向本科生的智能科研论文理解 Agent》。项目背景、目标、总体架构、工具集、Self-Correction、双索引长期记忆、交互设计和改进方向均沿用这份手写报告的学习脉络；安装、配置、部署方法和技术边界则结合本地最新版本源代码逐项核对并补充。手写报告图片仅作为整理依据，不包含在公开仓库中。
